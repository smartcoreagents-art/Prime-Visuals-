...
window.addEventListener('scroll', () => {
    ...
    if (stickyHeader) {
        if (currentScroll > 100) {
            ...
            stickyHeader.style.boxShadow = '0 1px 2px 0 rgba(0, 0, 0, 0.05)';
        }
    }
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.benefit-card, .service-card, .testimonial-card, .case-study, .team-member, .value-card');
    ...
    entries.forEach(entry => {
        if (entry.isIntersecting && !entry.target.classList.contains('animated')) {
            ...
            if (statNumber) {
                ...
                // Extract number from text (handles formats like "250+", "$50M+", "98%")
...
// ============================================
// Uncomment and implement if you want a rotating testimonial carousel
/*
...
// ============================================
console.log('%c🚀 Your Agency Website', 'font-size: 20px; font-weight: bold; color: #6366f1;');
